...
[DiscountAmount] [decimal] (18, 2) NOT NULL CONSTRAINT [DF__Order__DiscountA__28B808A7] DEFAULT ((0)),
...
[UpdateDate] [datetime2] NOT NULL CONSTRAINT [DF__Order__UpdateDat__2B947552] DEFAULT (sysutcdatetime()),
[CreationDate] [datetime2] NOT NULL CONSTRAINT [DF__Order__CreationD__2AA05119] DEFAULT (sysutcdatetime())
) ON [PRIMARY]
GO
