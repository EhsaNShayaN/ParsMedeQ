...
public static class QueryableExtensions
{
    ...
    public static IQueryable<TQuery> WhereIn<TQuery, TKey>(
        ...
        IValueBucketizer? valueBucketizer = null)
    where TKey : notnull
    {
        ...
        valueBucketizer ??= ValueBucketizer.Instance;
    ...
    public static IQueryable<TQuery> WhereIn<TQuery, TKey>(
        ...
        IEnumerable<TKey> values)
        where TKey : notnull
        => queryable.WhereIn(keySelector, values, ValueBucketizer.Instance);
    ...
    public static IQueryable<TQuery> WhereNotIn<TQuery, TKey>(
        ...
        IEnumerable<TKey> values)
        where TKey : notnull
        => queryable.WhereNotIn(keySelector, values, ValueBucketizer.Instance);
