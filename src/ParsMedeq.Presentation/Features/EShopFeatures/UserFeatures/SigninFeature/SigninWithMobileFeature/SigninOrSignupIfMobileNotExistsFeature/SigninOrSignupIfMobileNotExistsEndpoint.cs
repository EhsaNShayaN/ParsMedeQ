using EShop.Application.Features.EShopFeatures.UserFeatures.SigninFeature.SigninWithMobileFeature.SigninOrSignupIfMobileNotExistsFeature;
...
namespace EShop.Presentation.Features.EShopFeatures.UserFeatures.SigninFeature.SigninWithMobileFeature.SigninOrSignupIfMobileNotExistsFeature;
    ...
    SigninOrSignupIfMobileNotExistsApiResponse>
{
    ...
    public SigninOrSignupIfMobileNotExistsEndpoint(
       ...
       EShopEndpoints.User.SigninWithMobile,
       HttpMethod.Post,
       requestMapper,
       responseMapper)
    {
