...
public interface IResourceWriteRepository : IDomainRepository
{
    ...
    ValueTask<PrimitiveResult<ResourceCategory>> FindCategoryWithResources(int id, CancellationToken cancellationToken);
    ...
    ValueTask<PrimitiveResult<ResourceCategory>> DeleteCategory(ResourceCategory resourceCategory, CancellationToken cancellationToken);
}
