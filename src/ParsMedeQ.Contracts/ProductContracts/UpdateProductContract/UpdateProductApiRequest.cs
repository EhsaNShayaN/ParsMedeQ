...
public sealed class UpdateProductApiRequest
{
    ...
    public static async ValueTask<UpdateProductApiRequest?> BindAsync(HttpContext context, ParameterInfo _)
    {
        var form = await context.Request.ReadFormAsync(context.RequestAborted).ConfigureAwait(false);
        return FormBinderHelper.Bind<UpdateProductApiRequest>(form);
    }
}